...
object TestCogroup {
  def main(args: Array[String]): Unit = {
    ...
    val test1 = new FlinkKafkaConsumer010[DwdMember]("test_1", new DwdMemberDeserializationSchema, consumerProps)
    val test2 = new FlinkKafkaConsumer010[DwdMemberRegtype]("test_2", new DwdMemberRegtypeDeserializationSchema, consumerProps)
