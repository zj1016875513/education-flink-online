...
//            producer.send(new ProducerRecord<String,String>("test_1",i+"\tname"+i+"\t18"));
//        }
        for (int i = 0; i < 10; i++) {
            ...
            producer.send(new ProducerRecord<String, String>("test_1", jsonString));
        }
        for (int i = 0; i < 10; i++) {
            ...
            producer.send(new ProducerRecord<String, String>("test_2", jsonString));
        }
        producer.flush();
        producer.close();
    }
